-- ==========================================================
--          WAFI ULTIMATE HUB (AUTO KILL + FIXED 5 MIN JUMP)
-- ==========================================================
...
-- ==========================================================
--  الحلقة المدمجة (ملاحقة + ذبح + قفز مؤكد كل 5 دقائق)
-- ==========================================================
...
getgenv().Wafi_MainLoop = task.spawn(function()
    while task.wait(0.01) do
        pcall(function()
            ...
            -- مفتاح القفز التلقائي المؤكد كل 300 ثانية (5 دقائق)
            if os.clock() - lastJumpTick >= 300 then
