...
-- إعدادات الهيت بوكس (تم تخفيف اللوب قليلاً لتحسين الأداء)
...
-- تعديل دالة تحديث واجهة الـ IDs المحفوظة والدخول
local function refreshSavedUI()
    ...
    for i, id in ipairs(savedPlaceIds) do
        ...
        -- إصلاح مشكلة دخول نفس السيرفر العشوائي: استخدام Teleport بشكل آمن
...
-- إصلاح زر الانتقال المباشر بالـ ID
...
-- اللوب التشغيلي الرئيسي (تم ضبط العداد لتخفيف الضغط)
