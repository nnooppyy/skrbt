-- ==========================================================
--     WAFI ULTIMATE HUB (AUTO-APPROACH & KILL 1.10)
-- ==========================================================
...
-- ==========================================================
--           الحلقة الأساسية للانتقال والذهاب والذبح
-- ==========================================================
local lastJumpTick = os.clock()
local wasMoving = false
local heightOffset = 1.10 -- القيمة المحددة للارتفاع
            ...
            if (isSuicideMode or isKillMode) and targetName ~= "" then
                ...
                if myChar and targetPlr and targetPlr.Character then
                    ...
                    if myHum and myRoot and tHum and tRoot and myHum.Health > 0 and tHum.Health > 0 then
                        ...
                        -- إضافة مثبت المحاذاة والارتفاع المباشر للطيران والانتقال المباشر للهدف
                        local bodyPos = myRoot:FindFirstChild("Wafi_BodyPos")
                        if not bodyPos then
                            bodyPos = Instance.new("BodyPosition")
                            bodyPos.Name = "Wafi_BodyPos"
                        ...
                        -- تعيين الموضع بدقة مرتفعة بمقدار 1.10 فوق الهدف مباشرة
