-- ==========================================================
--  WAFI ULTIMATE HUB (CUSTOM SPEED CONTROL & APPROACH 1.10)
-- ==========================================================
...
-- ==========================================================
--               قسم التحكم بالسرعة (SPEED CONTROLLER)
-- ==========================================================
local moveSpeed = 60 -- السرعة الافتراضية

local SpeedFrame = Instance.new("Frame")
SpeedFrame.Size = UDim2.new(0, 235, 0, 32)
...
MinusBtn.Position = UDim2.new(0, 75, 0.5, -11)
...
SpeedBox.Position = UDim2.new(0, 103, 0.5, -11)
SpeedBox.BackgroundColor3 = Theme.Background
SpeedBox.TextColor3 = Theme.ON
...
PlusBtn.Position = UDim2.new(0, 177, 0.5, -11)
...
MinusBtn.MouseButton1Click:Connect(function()
    moveSpeed = math.max(5, moveSpeed - 10)
    SpeedBox.Text = tostring(moveSpeed)
end)
...
GoBtn.Position = UDim2.new(0, 10, 0, 132)
...
KillBtn.Position = UDim2.new(0, 10, 0, 162)
...
InvisBtn.Position = UDim2.new(0, 10, 0, 192)
            ...
            if (isSuicideMode or isKillMode) and targetName ~= "" then
                ...
                if myChar and targetPlr and targetPlr.Character then
                    ...
                    if myHum and myRoot and tHum and tRoot and myHum.Health > 0 and tHum.Health > 0 then
                        ...
                        if dist > 1.5 then
                            -- استخدام السرعة المحسوبة للانتقال
