-- ==========================================================
--          WAFI ULTIMATE HUB (FIXED SERVER HOP)
-- ==========================================================
...
-- وظيفة البحث عن سيرفر آخر متاح بعيداً عن السيرفر الحالي
    ...
    pcall(function()
        ...
        if res and res.data then
            ...
            for _, server in ipairs(res.data) do
                -- شرط ألا يكون السيرفر هو نفس السيرفر الحالي وأن يكون فيه أماكن شاغرة
                if server.id ~= currentJobId and server.playing < server.maxPlayers and server.playing > 0 then
                    table.insert(availableServers, server)
                end
            end
            
            -- ترتيب السيرفرات من الأقل عدداً للأكثر
            ...
            if #availableServers > 0 then
                ...
                -- في حال عدم إيجاد سيرفر عبر API يتم الانتقال بشكل عشوائي عام
