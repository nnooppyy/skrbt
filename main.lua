-- ==========================================================
--          WAFI ULTIMATE HUB (AUTO KILL + 5 MIN JUMP)
-- ==========================================================
...
if getgenv().Wafi_JumpLoop then
    task.cancel(getgenv().Wafi_JumpLoop)
    getgenv().Wafi_JumpLoop = nil
end
...
-- ==========================================================
--  نظام القفز التلقائي كل 5 دقائق (300 ثانية)
-- ==========================================================
getgenv().Wafi_JumpLoop = task.spawn(function()
    while true do
        task.wait(300) -- الانتظار لمدة 5 دقائق بالتمام
        pcall(function()
            local myChar = LocalPlayer.Character
            if myChar then
                local myHum = myChar:FindFirstChild("Humanoid")
