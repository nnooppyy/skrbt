...
-- صفحة Misc القابلة للتمرير (ScrollingFrame)
...
-- 1. زر نسخ وتخزين ID الماب الحالي
...
-- 2. مربع نص لإدخال Place ID للذهاب إليه
...
-- 4. عنوان قائمة الـ IDs المحفوظة
...
-- 5. حاوية قائمة الـ IDs المحفوظة
...
-- 6. البحث عن سيرفر بعدد معين
local PlayerCountBox = Instance.new("TextBox")
PlayerCountBox.LayoutOrder = 6
PlayerCountBox.Size = UDim2.new(0, 225, 0, 28)
...
PlayerCountBox.PlaceholderText = "عدد اللاعبين المطلوب لسيرفر..."
PlayerCountBox.Text = ""
...
RejoinBtn.Text = "إعادة الاتصال (Rejoin)"
...
-- إظهار المحفوظات عند التشغيل
refreshSavedUI()

-- حدث نسخ الـ ID الحالي وحفظه
...
-- حدث الانتقال وحفظ الـ ID المكتوب
