-- ==========================================================
--          WAFI ULTIMATE HUB + HITBOX EXPANDER [RANDOM HOP]
-- ==========================================================
...
-- دالة الانتقال لسيرفر عشوائي (Random Server Hop)
    ...
    pcall(function()
        ...
        if res and res.data then
            ...
            for _, server in ipairs(res.data) do
                -- جلب أي سيرفر متوفر ليس سيرفرنا الحالي وفيه أماكن فارغة
            ...
            if #availableServers > 0 then
                -- اختيار سيرفر عشوائي تماماً من القائمة
    ...
    if readfile and isfile and isfile(AutoHopFileName) then
        ...
        if isSearching then
            ...
            if found then
                ...
                warn("[WAFI HUB] لا يوجد شرطي يملك 500k، جاري البحث في سيرفر عشوائي...")
                hopToRandomServer()
            end
        end
    end
