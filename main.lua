...
-- استخراج ID الماب والسيرفر بدقة
local function parsePlaceAndJob(text)
    if not text or text == "" then return nil, nil end
    -- يقبل الصيغة اللي فيها فاصلة (PlaceId,JobId) أو النص العادي
