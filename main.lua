...
ToggleBtn.Text = "AFK Mode (ضغط رقم 3)  [ OFF ]"
...
ToggleBtn.MouseButton1Click:Connect(function()
    isAFK = not isAFK
    ToggleBtn.Text = isAFK and "AFK Mode (ضغط رقم 3)  [ ON ]" or "AFK Mode (ضغط رقم 3)  [ OFF ]"
...
InvisBtn.MouseButton1Click:Connect(function()
    ...
    toggleInvisibility(isInvisMode)
end)

-- نظام AFK الجديد المبسط: يضغط رقم 3، ينتظر ثانيتين، يضغطه مرة أخرى، وينتظر ثانيتين
task.spawn(function()
    while true do
        task.wait(2)
        pcall(function()
