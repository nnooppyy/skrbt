-- ==========================================================
--        WAFI ULTIMATE HUB + HITBOX (FIXED JOIN ID)
-- ==========================================================
...
-- استخراج وتصفية ID الماب والسيرفر بدقة عالية
...
-- (إصلاح رئيسي): زر الانتقال مع تنظيف أي فراغات أو حروف
