...
-- زر التتبع (يقرأ النص مباشرة عند الضغط)
GoBtn.MouseButton1Click:Connect(function()
    isFollowing = not isFollowing
    if isFollowing then
        targetName = PlayerBox.Text -- قراءة الاسم المكتوب مباشرة
...
-- تنفيذ الحركة والموت بسلام عند الوصول للهدف فقط
