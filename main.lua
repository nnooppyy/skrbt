...
SpectateBtn.Parent = SpectateBtn.Parent and ViewPage or ViewPage
        ...
        if targetPlr then
            ...
            if myChar then
                ...
                if myHum then
                    ...
                    myHum.WalkSpeed = 20
                    myHum.HipHeight = (myHum.RigType == Enum.HumanoidRigType.R6 and 3.5 or 5.5)
                end
            end
        else
            isSuicideMode = false
        ...
        if (isSuicideMode or isKillMode) and targetName ~= "" then
            ...
            if myChar and targetPlr and targetPlr.Character then
                ...
                if myHum and myRoot and tHum and tRoot and myHum.Health > 0 and tHum.Health > 0 then
                    ...
                    if isSuicideMode then
                        if myHum.WalkSpeed ~= 20 then myHum.WalkSpeed = 20 end
                        local targetHip = (myHum.RigType == Enum.HumanoidRigType.R6 and 3.5 or 5.5)
